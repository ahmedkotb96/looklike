    ...
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-0 py-0 mx-auto max-w-7xl">
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <div className="absolute top-0 right-0 max-h-full w-56 max-w-[80vw] bg-gradient-to-br from-white/[0.08] via-white/[0.05] to-white/[0.02] backdrop-blur-2xl border-l border-white/20 shadow-2xl rounded-l-2xl overflow-y-auto mt-6 mb-6"
            ...
            <div className="relative h-full flex flex-col">
              ...
              <div className="flex-1 px-6 py-8">
                <div className="space-y-2">
                  ...
                  {/* Premium CTA section moved here */}
                  <div className="p-0 pt-2">
                    <div className="relative">
                      <Button
                        ...
                        onClick={() => setMenuOpen(false)}
                      >
                        <span className="relative z-10 leading-tight text-[0.95rem] font-semibold tracking-tight">
                          Get Started
                        </span>
